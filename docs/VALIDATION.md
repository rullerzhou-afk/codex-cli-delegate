...
- **Current result:** 250 Python and 11 JavaScript tests pass across the
  portable and process-identity groups generated by `run_tests.py`. The Pi
  adapter adds native-session, model/effort, resume-prefix, tool-catalog, and
  evidence-export fixtures. All fixture suites avoid paid model calls.

...
REFERENCE_REQUIRED = {
    ...
    "native_identity": ["native worker cannot satisfy it", "must not be named or reported as that external backend"],
...
README_REQUIRED = [
    ...
    "native Codex worker cannot satisfy it or be reported as that backend",
